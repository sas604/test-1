...
! function(e) {
    ...
    var r = function() {
        ...
        return n(e, null, [{
            ...
            value: function(e) {
                ...
                return "POST" !== n.method && "PUT" !== n.method || (n.body = void 0 === i.data ? null : JSON.stringify(i.data)), void 0 !== i.cid && (n.headers.X_CID = void 0 === i.cid ? "" : i.cid), void 0 !== i.token && (n.headers.Authorization = void 0 === i.token ? "" : "Bearer " + i.token), new Promise(function(i, r) {
            ...
            value: function() {
                for (var e = new ClientJS, t = "", i = e.getBrowserData().ua, n = e.getCanvasPrint(), r = "&CustomFingerprint=" + e.getCustomFingerprint(i, n).toString(), o = "", s = [{
        ...
        return r(e, [{
            ...
            value: function(e, t, i) {
                if (e && "" !== e.toString().trim()) {
                    var n = this.baseAPIEndpoint + "/orders/" + e + "/relatedorders";
                    s.default.callAjax(n, {
                        cid: this.cid,
                        token: i
                    }).then(function(e) {
                ...
                try {
                    ...
                    if (a) {
                        ...
                        if (l && l.length > 0) {
                            ...
                            o.customer.IP || (o.customer.IP = u.ip), o.customer.Location || (o.customer.Location = {
                ...
                try {
                    ...
                    if (r && o) {
                        ...
                        if (a && a.length > 0) {
                            ...
                            n.customer.IP || (n.customer.IP = l.ip), n.customer.Location || (n.customer.Location = {
            ...
            value: function(e, t, i) {
                if (e && "" !== e)
                    if (t && "" !== t) {
                        ...
                        this.isTest && (n.indexOf("?") > 0 ? n += "&isTest=true" : n += "?isTest=true"), s.default.callAjax(n, {
                            cid: this.cid,
                            method: "PUT",
                            data: t
                        }).then(function(e) {
            ...
            value: function(e, t, i, n) {
                if (e && "" !== e)
                    if (t && "" !== t)
                        if (i && "" !== i) {
                            var r = "https://sales-prod.tryemanagecrm.com/api/orders/" + this.webkey + "?source=" + t + "&trackingNumber=" + e + "&midId=" + i;
                            this.isTest && (r.indexOf("?") > 0 ? r += "&isTest=true" : r += "?isTest=true"), s.default.callAjax(r, {
                                cid: this.cid,
                                method: "PUT",
                                data: {
            ...
            value: function(e, t) {
                if (e && void 0 !== e.email) {
                    ...
                    e.analyticsV2 = s.default.makeClientFingerPrint(), s.default.callAjax(i, {
                        cid: this.cid,
                        method: "POST",
                        data: e
                    }).then(function(e) {
            ...
            key: "getMidAndPrn",
            value: function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 54,
                    i = this.baseAPIEndpoint + "/campaigns/" + this.webkey + "/" + t + "/mid";
                this.isTest && (i.indexOf("?") > 0 ? i += "&isTest=true" : i += "?isTest=true"), s.default.callAjax(i, {
                    cid: this.cid
                }).then(function(t) {
    ...
    var a = function() {
        function e() {
            ...
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.webkey = t, this.cid = i, this.isTest = n, this.baseAPIEndpoint = void 0 !== r ? r : "https://websales-api.tryemanagecrm.com/api"
        }
        return r(e, [{
            key: "getUpsells",
            value: function(e) {
                s.default.callAjax(this.baseAPIEndpoint + "/campaigns/" + this.webkey + "/upsells", {
                    cid: this.cid
                }).then(function(t) {
                    "function" == typeof e && e(t)
                }).catch(function(t) {
            ...
            key: "getLocation",
            value: function(e) {
                s.default.callAjax(this.baseAPIEndpoint + "/campaigns/" + this.webkey + "/customers/location", {
                    cid: this.cid
                }).then(function(t) {
                    "function" == typeof e && e(t)
                }).catch(function(t) {
    ...
    (function(t, i) {
        ...
        n = function() {
            ...
            function M(e, t) {
                e._state === C && (e._result = t, e._state = T, 0 !== e._subscribers.length && a(L, e))
            }
            ...
            function j(e, t, i, n) {
                var r = e._subscribers,
                    o = r.length;
                e._onerror = null, r[o] = t, r[o + T] = i, r[o + k] = n, 0 === o && e._state && a(L, e)
            }
            ...
            function L(e) {
                var t = e._subscribers,
                    i = e._state;
                if (0 !== t.length) {
                    for (var n = void 0, r = void 0, o = e._result, s = 0; s < t.length; s += 3) n = t[s], r = t[s + i], n ? U(i, n, r, o) : r(o);
            ...
            function U(t, i, n, r) {
                ...
                if (o) {
                    if ((s = function(e, t) {
                        ...
                        }(n, r)) === I ? (u = !0, a = s.error, s.error = null) : l = !0, i === s) return void B(i, new TypeError("A promises callback cannot return that same promise."))
                } else s = r, l = !0;
                i._state !== C || (o && l ? x(i, s) : u ? B(i, a) : t === T ? M(i, s) : t === k && B(i, s))
            }
            var D = 0;
            ...
            var o = {
                ...
                writeAppletTag: function(e, t) {
                    var i = "<applet ",
                        n = "",
                        o = !0;
                    for (var s in null != t && "object" == typeof t || (t = {}), e) {
                        var a;
                        e: {
                            a = s.toLowerCase();
                        ...
                        a ? (i += " " + s + '="' + e[s] + '"', "code" == s && (o = !1)) : t[s] = e[s]
                    }
                    for (var c in s = !1, t) "codebase_lookup" == c && (s = !0), "object" != c && "java_object" != c && "java_code" != c || (o = !1), n += '<param name="' + c + '" value="' + t[c] + '"/>';
                    s || (n += '<param name="codebase_lookup" value="false"/>'), o && (i += ' code="dummy"'), document.write(i + ">\n" + n + "\n</applet>")
                },
                versionCheck: function(t) {
                    var i = 0,
                        n = t.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?(\\*|\\+)?$");
                    if (null != n) {
                        for (var r = t = !1, o = [], s = 1; s < n.length; ++s) "string" == typeof n[s] && "" != n[s] && (o[i] = n[s], i++);
                        for ("+" == o[o.length - 1] ? (r = !0, t = !1, o.length--) : "*" == o[o.length - 1] ? (r = !1, t = !0, o.length--) : 4 > o.length && (r = !1, t = !0), i = this.getJREs(), s = 0; s < i.length; ++s)
                ...
                compareVersionToPattern: function(e, t, i, n) {
                    ...
                    if (null != r) {
                        var o = 0;
                        e = [];
                        for (var s = 1; s < r.length; ++s) "string" == typeof r[s] && "" != r[s] && (e[o] = r[s], o++);
    ...
    function c(e, t) {
        var i, n, r, o, s;
        for (i = 3 & e.length, n = e.length - i, r = t, s = 0; s < n;) o = 255 & e.charCodeAt(s) | (255 & e.charCodeAt(++s)) << 8 | (255 & e.charCodeAt(++s)) << 16 | (255 & e.charCodeAt(++s)) << 24, ++s, r = 27492 + (65535 & (r = 5 * (65535 & (r = (r ^= o = 461845907 * (65535 & (o = (o = 3432918353 * (65535 & o) + ((3432918353 * (o >>> 16) & 65535) << 16) & 4294967295) << 15 | o >>> 17)) + ((461845907 * (o >>> 16) & 65535) << 16) & 4294967295) << 13 | r >>> 19)) + ((5 * (r >>> 16) & 65535) << 16) & 4294967295)) + ((58964 + (r >>> 16) & 65535) << 16);
        switch (o = 0, i) {
            case 3:
            ...
            case 1:
                r ^= 461845907 * (65535 & (o = (o = 3432918353 * (65535 & (o ^= 255 & e.charCodeAt(s))) + ((3432918353 * (o >>> 16) & 65535) << 16) & 4294967295) << 15 | o >>> 17)) + ((461845907 * (o >>> 16) & 65535) << 16) & 4294967295
        }
    ...
    var d = function() {
        ...
        function u(e, t, i) {
            ...
            if (r)
                if (void 0 === e.id && (e.id = i), B.ie && B.win) {
                    ...
                    for (var a in o = "", t) t[a] != Object.prototype[a] && (o += '<param name="' + a + '" value="' + t[a] + '" />');
                    r.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + s + ">" + o + "</object>", _[_.length] = e.id, n = h(e.id)
                } else {
                    for (var l in (a = S.createElement("object")).setAttribute("type", "application/x-shockwave-flash"), e) e[l] != Object.prototype[l] && ("styleclass" == l.toLowerCase() ? a.setAttribute("class", e[l]) : "classid" != l.toLowerCase() && a.setAttribute(l, e[l]));
                    for (s in t) t[s] != Object.prototype[s] && "movie" != s.toLowerCase() && (e = a, o = s, l = t[s], (i = S.createElement("param")).setAttribute("name", o), i.setAttribute("value", l), e.appendChild(i));
        ...
        var v, y, b, w, A, E, P = window,
            ...
            B = function() {
                var e = void 0 !== S.getElementById && void 0 !== S.getElementsByTagName && void 0 !== S.createElement,
                    ...
                    o = [0, 0, 0],
                    s = null;
                if (void 0 !== C.plugins && "object" == typeof C.plugins["Shockwave Flash"]) !(s = C.plugins["Shockwave Flash"].description) || void 0 !== C.mimeTypes && C.mimeTypes["application/x-shockwave-flash"] && !C.mimeTypes["application/x-shockwave-flash"].enabledPlugin || (T = !0, r = !1, s = s.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), o[0] = parseInt(s.replace(/^(.*)\..*$/, "$1"), 10), o[1] = parseInt(s.replace(/^.*\.(.*)\s.*$/, "$1"), 10), o[2] = /[a-zA-Z]/.test(s) ? parseInt(s.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
                else if (void 0 !== P.ActiveXObject) try {
                    var a = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
                    a && (s = a.GetVariable("$version")) && (r = !0, s = s.split(" ")[1].split(","), o = [parseInt(s[0], 10), parseInt(s[1], 10), parseInt(s[2], 10)])
                } catch (e) {}
                return {
                    w3: e,
                    pv: o,
        ...
        return B.w3 && ((void 0 !== S.readyState && "complete" == S.readyState || void 0 === S.readyState && (S.getElementsByTagName("body")[0] || S.body)) && e(), x || (void 0 !== S.addEventListener && S.addEventListener("DOMContentLoaded", e, !1), B.ie && B.win && (S.attachEvent("onreadystatechange", function() {
            ...
            embedSWF: function(e, i, n, r, a, l, c, d, h, p) {
                ...
                B.w3 && !(B.wk && 312 > B.wk) && e && i && n && r && a ? (m(i, !1), t(function() {
                    n += "", r += "";
                    var t = {};
                    ...
                    if (f(a)) y = u(t, v, i), t.id == i && m(i, !0), g.success = !0, g.ref = y;
                    else {
    ...
    ! function(i, n) {
        var r = {
            ...
            o = function() {
                for (var e, t, i, r, o, s, a, l = 0, u = arguments; l < u.length && !s;) {
                    var c = u[l],
                        d = u[l + 1];
                    if (void 0 === e)
                    ...
                    for (t = i = 0; t < c.length && !s;)
                        if (s = c[t++].exec(this.getUA()))
                            for (r = 0; r < d.length; r++) a = s[++i], "object" == typeof(o = d[r]) && 0 < o.length ? 2 == o.length ? e[o[0]] = "function" == typeof o[1] ? o[1].call(this, a) : o[1] : 3 == o.length ? e[o[0]] = "function" != typeof o[1] || o[1].exec && o[1].test ? a ? a.replace(o[1], o[2]) : n : a ? o[1].call(this, a, o[2]) : n : 4 == o.length && (e[o[0]] = a ? o[3].call(this, a.replace(o[1], o[2])) : n) : e[o] = a || n;
                    l += 2
                }
                return e
            },
    ...
    void 0 === (n = window).EmanageCRMJS && (n.EmanageCRMJS = function e() {
        ...
        }, this.Campaign = new o.default(this.webkey, this.cid, this.isTest, t.baseGetAPIEndpoint), this.Order = new s.default(this.webkey, this.cid, this.isTest, t.basePostAPIEndpoint)
    })
}, function(e, t, i) {
    e.exports = i(10)
}]);
